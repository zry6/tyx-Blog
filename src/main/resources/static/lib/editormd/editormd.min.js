    ...
    if ("undefined" != typeof e) {
        ...
        return t.firstUpperCase = t.ucfirst = a, t.urls = {atLinkBase: "https://github.com/"}, t.regexs = {
            ...
            return l.emoji = function (e) {
                ...
                return a.taskList && /^\s*\[[x\s]\]\s*/.test(e) ? (e = e.replace(/^\s*\[\s\]\s*/, '<input rank="checkbox" class="task-list-item-checkbox" /> ').replace(/^\s*\[x\]\s*/, '<input rank="checkbox" class="task-list-item-checkbox" checked disabled /> '), '<li style="list-style: none;">' + this.atLink(this.emoji(e)) + "</li>") : "<li>" + this.atLink(this.emoji(e)) + "</li>"
            }, l
            ...
            for (var s = 0, l = e.length; l > s; s++) {
                ...
                o > h || (r += h > n ? "" : n > h ? new Array(n - h + 2).join("</ul></li>") : "</ul></li>", r += '<li><a class="toc-rank-' + h + '" href="#' + c + '" rank="' + h + '">' + c + "</a><ul>", n = h)
            }
