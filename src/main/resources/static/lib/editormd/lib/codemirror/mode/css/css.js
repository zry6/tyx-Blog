...
CodeMirror.defineMode("css", function(config, parserConfig) {
  ...
  var propertyKeywords_ = [
    ...
    "bleed", "bookmark-label", "bookmark-rank", "bookmark-state",
    ...
    "list-style-image", "list-style-position", "list-style-rank", "margin",
    ...
    "presentation-rank", "punctuation-trim", "quotes", "region-break-after",
