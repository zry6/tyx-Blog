...
public class AdminTypeController {
    ...
    public RespBean typePage(@RequestParam(defaultValue = "1") Integer current, @RequestParam(defaultValue = "5") Integer size) {
        Page<Type> pageVo = typeService.typePage(current, size);
